              ...
              <CCard className="p-4" style={{boxShadow: '0px 15px 34px 0px rgba(0,0,0,0.2)'}}>
                <CCardBody>
                  <CForm style={{textAlign: "center"}}>
                    ...
                    <p className="text-body-secondary" style={{marginTop:"15px"}}>Please enter your credentials to login.</p>

                    <CInputGroup className="mb-3" style={{marginTop:"20px"}}>
                      <CInputGroupText style={{borderColor:"rgb(71, 71, 212)", backgroundColor:"rgb(71, 71, 212)", color:"#fff"}}>
                        <CIcon icon={cilUser} />
                      </CInputGroupText>
                      <CFormInput placeholder="Username" autoComplete="username" style={{borderColor:"rgb(71, 71, 212)", }}/>
                    </CInputGroup>
